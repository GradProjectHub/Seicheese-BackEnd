...
(11, '愛知県名古屋市熱田区神宮4丁目7-35', '456-0031');
-- +goose StatementEnd
...
(1, '名古屋工学院専門学校3号館', '名古屋工学院専門学校の3号館建物です。', 35.1209584, 136.911830, 11, 11);
-- +goose StatementEnd
...
DELETE FROM places WHERE place_id IN (1, 2, 3, 4, 5,11);
DELETE FROM contents WHERE content_id IN (1, 2, 3, 4, 5,11);
-- +goose StatementEnd 